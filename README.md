EDA выполнен на основе https://www.kaggle.com/code/juliencs/a-study-on-regression-applied-to-the-ames-dataset?utm_source=chatgpt.com
...
Проект тестировался на Python 3.13.

Склонируйте репозиторий и перейдите в его директорию:

```bash
git clone <URL_ВАШЕГО_РЕПОЗИТОРИЯ>
cd Final_project_house_pricing
```
